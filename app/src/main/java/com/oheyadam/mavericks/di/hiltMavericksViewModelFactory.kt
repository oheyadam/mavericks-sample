...
class HiltMavericksViewModelFactory<VM : MavericksViewModel<S>, S : MavericksState>(
    ...
    override fun create(viewModelContext: ViewModelContext, state: S): VM {
        ...
        val componentBuilder = EntryPoints.get(viewModelContext.app(), CreateMavericksViewModelComponent::class.java)
            .mavericksViewModelComponentBuilder()
        val viewModelComponent = componentBuilder.build()
        val viewModelFactoryMap = EntryPoints.get(viewModelComponent, HiltMavericksEntryPoint::class.java)
            .viewModelFactories
